...
- [x] **Step 1: Document the manual test procedure**

See `docs/manual-test-phase1.md` for complete test documentation.

- [ ] **Step 2: Run the manual test procedure**

BLOCKED: webkit2gtk not installed on dev host. Manual smoke test requires native Tauri window support (webkit2gtk-4.1) to launch the sharer application. This test will be performed on a properly-equipped Linux dev box with GUI support.
