...
const MESSAGES: Record<Lang, Record<string, Entry>> = {
  de: {
    ...
    "join.codeExpired": "Der Code wurde nach zu vielen Fehlversuchen gesperrt. Bitte beim Helfer einen neuen Code anfragen.",
  ...
  en: {
    ...
    "join.codeExpired": "The code was locked after too many failed attempts. Please ask the other person for a new code.",
