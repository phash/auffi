...
set "MSI=\\host.lan\Data\Auffi_0.7.0_x64_en-US.msi"
set "MSILOG=\\host.lan\Data\msi-log.txt"
set "FAILED=0"

> "%RES%" echo ===== Auffi 0.7.0 Windows-Installer-Smoke =====
...
set "PORT=\\host.lan\Data\Auffi_0.7.0_x64_portable.exe"
if not exist "%PORT%" (
    >> "%RES%" echo.
...
set "NSIS=\\host.lan\Data\Auffi_0.7.0_x64-setup.exe"
if not exist "%NSIS%" (
    >> "%RES%" echo.
